...
#ifndef NAILONG_KERNEL_TESTS_UNIT_TEST_MOCKS_CPU_IO_H_
#define NAILONG_KERNEL_TESTS_UNIT_TEST_MOCKS_CPU_IO_H_
...
#endif /* NAILONG_KERNEL_TESTS_UNIT_TEST_MOCKS_CPU_IO_H_ */
