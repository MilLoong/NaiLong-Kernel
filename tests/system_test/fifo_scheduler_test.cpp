...
auto test_fifo_basic_functionality() -> bool {
  nk_printf("Running test_fifo_basic_functionality...\n");
  ...
  nk_printf("test_fifo_basic_functionality passed\n");
  return true;
}

auto test_fifo_ordering() -> bool {
  nk_printf("Running test_fifo_ordering...\n");
  ...
  nk_printf("test_fifo_ordering passed\n");
  return true;
}

auto test_fifo_dequeue() -> bool {
  nk_printf("Running test_fifo_dequeue...\n");
  ...
  nk_printf("test_fifo_dequeue passed\n");
  return true;
}

auto test_fifo_statistics() -> bool {
  nk_printf("Running test_fifo_statistics...\n");
  ...
  nk_printf("test_fifo_statistics passed\n");
  return true;
}

auto test_fifo_mixed_operations() -> bool {
  nk_printf("Running test_fifo_mixed_operations...\n");
  ...
  nk_printf("test_fifo_mixed_operations passed\n");
  return true;
}

auto test_fifo_repeated_enqueue() -> bool {
  nk_printf("Running test_fifo_repeated_enqueue...\n");
  ...
  nk_printf("test_fifo_repeated_enqueue passed\n");
  return true;
}

auto test_fifo_hooks() -> bool {
  nk_printf("Running test_fifo_hooks...\n");
  ...
  nk_printf("test_fifo_hooks passed\n");
  return true;
}

auto test_fifo_robustness() -> bool {
  nk_printf("Running test_fifo_robustness...\n");
  ...
  nk_printf("test_fifo_robustness passed\n");
  return true;
}
...
auto fifo_scheduler_test() -> bool {
  ...
  nk_printf("=== All FIFO Scheduler Tests Passed ===\n\n");
  return true;
}
