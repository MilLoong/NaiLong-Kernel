...
# Vendored under 3rd/cpu_io (not a submodule; includes NaiLong-Kernel patches)
...
IF(NOT EXISTS ${dtc_BINARY_DIR}/libfdt/libfdt.a)
    ADD_CUSTOM_TARGET (
        ...
        COMMAND CC=${dtc_CC} AR=${dtc_AR} HOME=${dtc_BINARY_DIR}
                EXTRA_CFLAGS=-Wno-error=discarded-qualifiers make
