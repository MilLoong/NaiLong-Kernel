...
#ifndef NAILONG_KERNEL_SRC_LIBC_INCLUDE_NK_STDLIB_H_
#define NAILONG_KERNEL_SRC_LIBC_INCLUDE_NK_STDLIB_H_
...
#endif /* NAILONG_KERNEL_SRC_LIBC_INCLUDE_NK_STDLIB_H_ */
