...
#ifndef NAILONG_KERNEL_SRC_DRIVER_ACPI_INCLUDE_ACPI_H_
#define NAILONG_KERNEL_SRC_DRIVER_ACPI_INCLUDE_ACPI_H_
...
#endif /* NAILONG_KERNEL_SRC_DRIVER_ACPI_INCLUDE_ACPI_H_ */
