...
#ifndef NAILONG_KERNEL_SRC_DRIVER_APIC_INCLUDE_LOCAL_APIC_H_
#define NAILONG_KERNEL_SRC_DRIVER_APIC_INCLUDE_LOCAL_APIC_H_
...
#endif /* NAILONG_KERNEL_SRC_DRIVER_APIC_INCLUDE_LOCAL_APIC_H_ */
